package cn.jiiiiiin.vplus.ui.animation;
...
import cn.jiiiiiin.vplus.ui.dimen.ScreenUtils;

public final class BezierAnimation {

    public static void addCart(AbstractViewPlusDelegate delegate, View start, View end,
